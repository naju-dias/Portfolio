...
export default function BootSequenceUI({ exiting, displayProgress, visibleLines }: BootSequenceUIProps) {
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "clamp(6px, 1.6vw, 14px)", flexWrap: "wrap", justifyContent: "center" }}>
          ...
          <span style={{ fontFamily: "Geist Mono, monospace", fontWeight: 400, fontSize: "clamp(24px, 5vw, 52px)", color: "#6f6c78", lineHeight: 0.9 }}>(</span>
          <h3 style={{ margin: 0, marginTop: "clamp(4px, 1vw, 7px)", fontFamily: "Tanker, serif", fontWeight: 400, fontSize: "clamp(22px, 5vw, 52px)", lineHeight: 0.9, color: "#6758bf", whiteSpace: "nowrap" }}>
            NAJU DIAS
          </h3>
          <span style={{ fontFamily: "Geist Mono, monospace", fontWeight: 400, fontSize: "clamp(24px, 5vw, 52px)", color: "#6f6c78", lineHeight: 0.9 }}>)</span>
          <span style={{ fontFamily: "JetBrains Mono, monospace", fontWeight: 500, fontSize: "clamp(13px, 1.6vw, 22px)", color: "#f7f7ff", marginLeft: "4px", minWidth: "3ch" }}>
            {displayProgress}%
          </span>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "clamp(6px, 1.4vw, 8px)", width: "min(360px, 100%)", marginTop: "8px" }}>
          {BOOT_LINES.map((line, i) => (
            ...
            >
              ...
              <motion.span variants={pieceVariants} style={{ color: "#6758bf", fontWeight: 500, whiteSpace: "nowrap" }}>
                [{line.status}]
              </motion.span>
            </motion.div>
          ))}
