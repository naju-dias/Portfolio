...
// Conteúdo compartilhado entre a versão desktop (Framer) e mobile (CSS puro)
function ModalContent({ project, onClose }: ProjectModalProps) {
  ...
  if (isMobile) {
    return (
      <div className="modal-backdrop modal-backdrop--css" onClick={onClose}>
        <div className="modal modal--css" onClick={(e) => e.stopPropagation()}>
